...
<div class="pb-48 px-0" style="background-color: #FFF;">
    <div class=" grid gap-4  pt-20 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 ">
        <div class="text-center">
            ...
            <p style="margin-top: -91px; font-size:45px" class="text-gray-500 bold text-3xl "> Welcome to the true stories <br> powerhouse in Middle East</p>
        </div>
        <div class="pt-24 ">
