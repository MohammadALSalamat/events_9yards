                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Form To <small> Add Category</small></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="{{ route('update_category',$edit_category->id) }}" method="post"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category" class="form-control" id="exampleInputEmail1"
                                            placeholder="Eg: Video , Camera , Image ....." value="{{ $edit_category->name }}">
                                    </div>
                                    <div class="form-group">
                                        <div
                                            class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                            <input type="checkbox" class="custom-control-input" id="customSwitch3"
                                                name="status" @if($edit_category->status == 1) checked @endif>
                                ...
                                <div class="card-footer">
                                  ...
                                  <a href="{{ route('view_category') }}"><button type="button" class="btn btn-danger">back</button></a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
