...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/backend_css/animation.css ') }}" />
...
<body>
    ...
    <div id="loginbox">
        <form id="loginform" class="form-vertical" action="{{ route('Front_Page') }}" method="POST">
            @csrf
            <div class="text-center control-group normal_text">
                <h3 style="color: silver; font-size: 50px">
                    <strong style="color: rgb(38, 104, 38)">User</strong>Login
                </h3>
            </div>
